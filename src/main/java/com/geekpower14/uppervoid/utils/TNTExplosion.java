...
public class TNTExplosion {
    ...
    public TNTExplosion(WorldServer world, Entity entity, double d0, double d1, double d2, float f, boolean flag, boolean flag1) {
        this.world = world;
        this.source = entity;
    ...
    public void a() {
        if (this.size >= 0.1F) {
            ...
            for (Entity entity : list) {
                double d7 = entity.e(this.posX, this.posY, this.posZ) / (double) var48;
